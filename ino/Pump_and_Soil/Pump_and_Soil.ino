...
ros::Publisher pub_soil0("val_soil0", &soil0);
ros::Publisher pub_soil1("val_soil1", &soil1);

ros::Subscriber<std_msgs::Bool> sub_pump0("/pump0", messageCb_pump0);
ros::Subscriber<std_msgs::Bool> sub_pump1("/pump1", messageCb_pump1);
